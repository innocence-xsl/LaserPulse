...
代码解读: 
    ...
    初始化中心波长 1030 nm、脉宽 200 fs 的高斯脉冲，并画出它的时域光强图和频域光谱图，
    搞清楚光谱图到底能给出什么信息:
    1.核心指标一：半高全宽,直接决定了光脉冲在理论上能被压缩到的最短时间。
    2.核心指标二：种子光与放大光的“前后对比” —— 增益窄化。
    3.核心指标三：光谱的平滑度与形状，脉冲是否存在明显的旁瓣或杂散光谱成分。
    4.核心指标四：中心波长的偏移，脉冲是否在理论中心波长附近。
==============================================================================
"""
import numpy as np
